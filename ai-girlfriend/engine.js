...
const Engine = (() => {
  ...
  const PERSONA_BREAK_RE = /(程序|AI|人工智能|机器人|助手|客服|帮不上|我只是|我不能|建议你去|寻求专业帮助|热线|12356|心理援助|专业人[士师]|虚拟|数字人|电子人|语言模型|被.{0,4}训练|训练出来|[你我]们?(?:不过?|其实|确实|本来|终究|无非|毕竟|真的)?[都也还只就]{0,2}是.{0,8}(gpt|siri|算法|代码|bot|app|模型))/i;
