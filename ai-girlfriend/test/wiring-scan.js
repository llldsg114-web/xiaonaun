...
const SIZE_BUDGET = {
  ...
  engineNetMax: 2400,      // 改配额必须走代码评审 · 主理人 Qi 于 v16 批准 2200→2400（V16-3 · :1307 四轴扩展 +190B）
  engineMax: 248137,       // 派生量 = engineBase + engineNetMax（V-33 真实硬上限；非配额项，改上面两项即自动失配，见下方自洽断言）
  "memory.js": 14154,      // 改配额必须走代码评审 · 主理人 Qi 于 v16 批准 14336→14154（让渡 182B 给 engineNet；实测 13371，余 783）
  ...
  moduleSumMax: 28343,     // 改配额必须走代码评审 · 主理人 Qi 于 v16 批准 28525→28343 = totalMax − engineMax(248137)
