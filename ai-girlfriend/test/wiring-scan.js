...
const SIZE_BUDGET = {
  ...
  engineNetMax: 2740,      // 改配额必须走代码评审 · 主理人于 v22 批准右移 +40（反向路径：memory/presence/texture 三模块回让 E=40B 予 engine，旧值与逐级推导见上方 v22 审批块）· 回让后 engine 侧实测 net 2699，余 41B
  engineMax: 248477,       // 派生量 = engineBase + engineNetMax（V-33 真实硬上限；非配额项，改上面两项即自动失配，见下方自洽断言）· v22 随回让同步翻转 ⇒ V33 引脚 7 文件必须同步，并集触达 13 文件（清单见 DESIGN-v22 §5 T-v33）
