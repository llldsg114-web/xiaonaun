...
const SIZE_BUDGET = {
  ...
  engineNetMax: 2800,      // 改配额必须走代码评审 · 主理人 Qi 于 v17 批准 2400→2800（Δ=+400 · 归一化层 + R2-A5b + selfTick 防重放）
  engineMax: 248537,       // 派生量 = engineBase + engineNetMax（V-33 真实硬上限；非配额项，改上面两项即自动失配，见下方自洽断言）
  "memory.js": 13824,      // 改配额必须走代码评审 · 主理人 Qi 于 v17 批准 14154→13824（让渡 330B · 13.5KiB 边界；预测实测 13331，余 493）
  "presence.js": 3840,     // 改配额必须走代码评审 · 主理人 Qi 于 v17 批准 4096→3840（让渡 256B · 3.75KiB 边界；预测实测 3566，余 274）
  "texture.js": 4608,      // 改配额必须走代码评审 · 主理人 Qi 于 v17 批准 5120→4608（让渡 512B · 4.5KiB 边界；预测实测 4366，余 242）
  "contingency.js": 5671,  // 改配额必须走代码评审 · 主理人 Qi 于 v17 批准 4973→5671（R-S2 二期载体 · 残差式 27943−22272）
  moduleSumMax: 27943,     // 改配额必须走代码评审 · 主理人 Qi 于 v17 批准 28343→27943 = totalMax − engineMax(248537)
