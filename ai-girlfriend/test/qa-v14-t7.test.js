...
test("V-113 · 体积四锁全绿，over = []；engine 净增锁死 2658", () => {
  ...
  assert.strictEqual(z.engineNet, 2658,
    "2658 = 2087 + v15 NOTE-2 的 13B + Q-V15-1 副词槽的 60B + v16 T1 四轴的 190B（均落 :1307 单行）+ v17 T1/T2 的 266B（13 行行内追加）+ v18 T1 零宽剥离的 42B（:1310 行内追加）");
